...
abstract class PageGenerator extends RendererBase
{
    ...
    protected function MaybeUpdateDataSource()
    {
    ...
    public function AddJSDependency($name)
    {
        $this->Loader->AddScript($name,'js/dist/RNPB'.$name.'_bundle.js',array('@runnablepage'));
