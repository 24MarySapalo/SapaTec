jQuery(document).ready(function($) {
    'use strict';
    var this_obj = digital_agency_lite_plugin_activate_plugin;
    ...
    $(document).on('click', '.digital-agency-lite-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message digital-agency-lite-plugin-install');
                button.addClass('button-primary digital-agency-lite-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.digital-agency-lite-recommended-plugins .digital-agency-lite-activation-note').css('display','block');
    ...
    $(document).on('click', '.digital-agency-lite-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .digital-agency-lite-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .digital-agency-lite-recommended-plugins').css('display','none');
    });
