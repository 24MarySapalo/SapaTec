...
if ( ! class_exists( 'Digital_Agency_Lite_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Digital_Agency_Lite_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Digital_Agency_Lite_WPTT_WebFont_Loader( $url );
